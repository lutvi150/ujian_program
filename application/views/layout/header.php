        ...
        ***********************************-->
		<div class="nav-header">
			<a href="<?=base_url()?>" class="brand-logo">
				<img class="logo-abbr" src="<?=base_url()?>assets/images/logo.svg" alt="">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									<img src="<?=base_url();?>assets/images/avatar/1.jpg" width="20" alt="" />
									<div class="header-info">
										<span
											class="text-black"><strong><?=$this->session->userdata('username')?></strong></span>
										<p class="fs-12 mb-0"><?=$this->session->userdata('role')?></p>
									</div>
								</a>
								<div class="dropdown-menu dropdown-menu-right">
									<?php if ($this->session->userdata('role') == 'atlet'): ?>
									<a href="<?=base_url()?>atlet/profil" class="dropdown-item ai-icon">
